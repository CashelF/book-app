...
def generate_user_preference_embedding(user_id):
    ...
    reading_history = user_repository.get_user_reading_history(user_id)
    
    book_embeddings = []
    for entry in reading_history:
        book = entry.book
        description = book.description
        book_embedding = get_book_embedding(description)
    ...
    user_repository.save_user_preferences_embedding(user_id, user_embedding)
